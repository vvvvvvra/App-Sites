    ...
    switch (type) {
        case 'terms-conditions':
            return `
                ...
                <p>
                These terms and conditions applies to the ${appDetails.name} app (hereby referred to as
                "Application") for mobile devices that was created by ${appDetails.developer.name} (hereby
                referred to as "Service Provider") as a ${appDetails.appType} service.
                </p>
                <br />
                <p>
                ...
                <br />
                <p>These terms and conditions are effective as of ${appDetails.effectiveDate}</p>
                <br /><strong>Contact Us</strong>
                <p>
                If you have any questions or suggestions about the Terms and Conditions,
                please do not hesitate to contact the Service Provider at a${appDetails.contact}.
                </p>
                <hr />
            `
        case 'policy':
            ...
            <p>
                This privacy policy applies to the ${appDetails.name} app (hereby referred to as
                "Application") for mobile devices that was created by ${appDetails.developer.name} (hereby
                referred to as "Service Provider") as a ${appDetails.appType} service. This service is
            ...
            <p>
                ...
                information, including but not limited to ${appDetails.personallyIdentifiableInformation}. The information that the Service Provider request will be
            ...
            <p>
                ...
                please contact them at ${appDetails.contact} and they will respond in a reasonable
                time.
            </p>
            <br />
            ...
            <div>
                ...
                <p>
                    ...
                    (${appDetails.contact}) so that they will be able to take the necessary actions.
                </p>
            </div>
            <br />
            ...
            <br />
            <p>This privacy policy is effective as of ${appDetails.effectiveDate}</p>
            <br />
            ...
            <p>
                ...
                via email at ${appDetails.contact}.
            </p>
        `    
        default:
            return ''
